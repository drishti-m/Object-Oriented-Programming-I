...
class Referee: public TournamentMember   //Referee is a child class of TournamentMember
{
private:
    int yellowCardCount;
...
public:
    Referee();
    Referee(char*,char*,char*,double,double,int,Player*ycl[50],int,Player*rcl[50]);
    //constructors
    ...
    void setYcc(int);
    void setRcc(int); //setters
    int getYcc();
    int getRcc(); //getters

    void print();
    //to print referee details and players in the list
};
